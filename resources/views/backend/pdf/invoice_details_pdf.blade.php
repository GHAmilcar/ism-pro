    ...
    <div class="row">
        <div class="col-12">
            <div class="invoice-title">
                ...
                <h3>
                    <img src="{{ asset('backend/assets/images/logo-sm.png') }}" alt="logo" height="24"/> ISM - PRO System
                </h3>
            </div>
            <hr>
...
<div class="table-responsive">
    <table class="table">
        ...
        <tr>
            ...
            <td class="text-center"><strong>DUI</strong>
            </td>
        ...
        <tr>
            ...
            <td class="text-center">{{ $payment['customer']['dui']  }}</td>
