...
<h4>Invoice No: {{ $invoice->invoice_no }} - {{ date('d-m-Y',strtotime($invoice->date)) }} </h4>
         ...
         <table border="1"  width="100%">
            <thead>
                <tr>
                    ...
                    <th class="text-center" style="background-color: red; color: white">Current Stock</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td class="text-center" style="background-color: red; color: white">{{ $details['product']['quantity'] }}</td>
            <td class="text-center">{{ $details->selling_qty }}</td>
            <td class="text-center">{{ $details->unit_price }}</td>
            <td class="text-center"><strong>{{ $details->selling_price }}</strong></td>
        </tr>
        @php
        ...
        <tr>
         ...
         <button type="submit" class="btn btn-dark mt-3">Invoice Approve </button>
