        ...
        $(document).on("click",".addeventmore", function(){
            ...
            var product_name = $('#product_id').find('option:selected').text();
                ...
                return false;
                  ...
                  if(supplier_id == '' || supplier_id == 'Open this select menu'){
...
<!-- Aqui definimos nuestras funciones, nos serviran para cargar nuestros productos por medio de proveedores -->
